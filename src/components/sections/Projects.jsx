...
const projects = [
  ...
  { title:'SOC Lab Using Splunk, MITRE & ServiceNow', desc:'Built a hands-on SOC lab with Splunk SIEM for centralized log collection, detection engineering, MITRE ATT&CK mapping, and ServiceNow-based incident handling across Windows, Linux, and Tailscale-connected endpoints.', tags:['Splunk','SIEM','MITRE ATT&CK','ServiceNow','Tailscale VPN','SOC'], icon:<Terminal size={22}/>, color:'#06b6d4', github:'https://github.com/sahal-thaha/SOC-Lab-Using-Splunk-MITRE-ServiceNow',featured:true,status:'done' },,
]
